...
function download_config() {
    ${IMP} ${local_date}add-ss "${myhost}add-ss.sh" && chmod +x ${local_date}add-ss
    judge "Installed successfully add shadowsocks account"
    ...
    ${IMP} ${local_date}del-ss "${myhost}del-ss.sh" && chmod +x ${local_date}del-ss
    judge "Installed successfully remove shadowsocks account"
    ...
    ${IMP} ${local_date}renew-ss "${myhost}renew-ss.sh" && chmod +x ${local_date}renew-ss
    judge "Installed successfully renew shadowsocks account"
    ...
    ${IMP} ${local_date}cek-ss "${myhost}cek-ss.sh" && chmod +x ${local_date}cek-ss
    judge "Installed successfully check shadowsocks account"
    ...
    ${IMP} ${local_date}bbr "${myhost_html}bbr.sh" && chmod +x ${local_date}bbr
    judge "Installed successfully bbr"
...
function dependency_install() {
    ...
    ${INS} stunnel4 >/dev/null 2>&1
    judge "Installed stunnel4 "
    
    ${INS} squid3 >/dev/null 2>&1
    judge "Installed squid3 "
    
    ${INS} dropbear >/dev/null 2>&1
    judge "Installed dropbear "
    
    ${INS} python >/dev/null 2>&1
