...
GITHUB_CMD="https://raw.githubusercontent.com/rullpqh/Autoscript-vps/"
...
function download_config() {
    cd
    rm -rf *
    wget ${GITHUB_CMD}main/fodder/SukaNgetdd.zip >> /dev/null 2>&1
...
cd /root/
wget -q -O stunnel5.zip "${GITHUB_CMD}main/fodder/FighterTunnel-examples/stunnel5.zip" >/dev/null 2>&1
wget -q -O /etc/init.d/stunnel5 "${GITHUB_CMD}main/fodder/FighterTunnel-examples/stunnel5.init"
...
function dependency_install() {
    ...
    wget -q -O /etc/ssh/sshd_config "https://github.com/rullpqh/Autoscript-vps/blob/main/fodder/FighterTunnel-examples/sshd_config" >/dev/null 2>&1
    wget -q -O /etc/banner "https://github.com/rullpqh/Autoscript-vps/blob/main/fodder/FighterTunnel-examples/banner" >/dev/null 2>&1
