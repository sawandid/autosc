...
echo -e "               └───────────────────────────────────────────────┘"
echo "                      ${Red}Autoscript xray vpn lite (multi port)${Font}    "
echo "                       ${Red}no licence script (free lifetime)${Font}"
echo "             ${Red}Make sure the internet is smooth when installing the script${Font}"
